...
const friends = ref([
  { id: 2, nickname: '친구A', profileImage: null },
  { id: 3, nickname: '친구B', profileImage: null },
  { id: 4, nickname: '친구C', profileImage: null },
  { id: 5, nickname: '친구D', profileImage: null },
])
  ...
  <div class="page-wrap">
    ...
    <div class="main-grid">
      ...
      <main class="feed-col">
        ...
        <!-- 정렬 탭 -->
        <div class="sort-tabs">
          <button class="sort-tab active">최신순</button>
          <button class="sort-tab">페이스 빠른 순</button>
          <button class="sort-tab">거리 긴 순</button>
        </div>
          ...
          >
            ...
            <div v-if="post.distance" class="post-stats">
              <span class="stat-chip">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#3b5bdb" stroke-width="2.2">
            ...
            <div class="post-footer">
              <button class="like-btn" :class="{ liked: post.liked }" @click="toggleLike(post)">
                <svg width="15" height="15" viewBox="0 0 24 24" :fill="post.liked ? '#e53e3e' : 'none'" stroke="#e53e3e" stroke-width="2">
      ...
      <aside class="sidebar-right">
        ...
        <div class="sidebar-card stats-card">
          <div class="stats-header">
            ...
            <button class="more-link" @click="router.push('/stats')">동계 더보기 →</button>
          </div>
        ...
        <div class="sidebar-card notice-card">
          <h2 class="sidebar-title notice-title">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="#e67e22" stroke="none">
              <path d="M18 3a1 1 0 0 0-1.447-.894L8.763 6H5a3 3 0 0 0 0 6h.28l1.771 5.316A1 1 0 0 0 8 18h1a1 1 0 0 0 1-1v-4.382l6.553 3.276A1 1 0 0 0 18 15V3z"/>
            </svg>
            공지사항
          </h2>
